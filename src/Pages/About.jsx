  ...
  <div className="flex justify-end items-center sm:p-12 sm:py-0 sm:pb-0 p-0 py-2 pb-2">
    ...
    >
      ...
      <div className="relative">
        <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105 bg-transparent">
          ...
          <img
            ...
            alt="Profile"
            className="w-full h-full object-cover object-[50%_15%] scale-100 transition-all duration-700 group-hover:scale-110 group-hover:rotate-2"
            loading="lazy"
          />
...
const AboutPage = () => {
  const [stats, setStats] = useState({
    totalProjects: 9,
    totalCertificates: 21, // Default to localized certificates count
  });
  ...
  useEffect(() => {
    const updateStats = () => {
      ...
      setStats({
        ...
        totalCertificates: Math.max(storedCertificates.length, 21), // Ensure minimum 21
      });
    };

    updateStats();
    
    // Listen for custom event from Portofolio to update stats dynamically
  ...
  const handleStatClick = useCallback((tabIndex) => {
    // Dispatch custom event to change tab
    window.dispatchEvent(new CustomEvent('changePortfolioTab', { detail: { tab: tabIndex } }));
  ...
  ], [totalProjects, totalCertificates, handleStatClick]);
    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             a Computer Science student with a strong interest in full-stack web development. I enjoy building modern, responsive web applications and solving complex problems using technology. With a solid foundation in web technologies and Data Structures & Algorithms, I focus on transforming ideas into practical digital solutions. I continuously improve my skills through hands-on projects, coding challenges, and by exploring new technologies.
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Learning AI as a professional tool, not a replacement."
        </blockquote>
      </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1Wbha0msHrddj-qg6UxiWN0IFVXtlHJH2/view?usp=sharing" className="w-full lg:w-auto" target="_blank" rel="noopener noreferrer">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
